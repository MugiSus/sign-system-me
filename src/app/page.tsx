...
export default function Home() {
  ...
  return (
    <main className="flex flex-col min-h-svh justify-center items-center">
      ...
      <textarea
        className="font-mono w-full max-w-xs resize-none outline-none text-center text-slate-300 hover:bg-slate-100 hover:text-slate-600 focus:bg-slate-100 focus:text-slate-600 px-4 py-2 rounded-t-md duration-200"
        defaultValue={string}
